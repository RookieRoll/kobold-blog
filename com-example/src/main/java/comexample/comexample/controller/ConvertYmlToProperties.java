...
public class ConvertYmlToProperties {

	public static  void convert() throws IOException {
		Yaml yaml = new Yaml();
		try (InputStream in = Files.newInputStream(Paths.get("D:\\DEMO\\Java\\kobolgblog\\kobold-blog-provider\\src\\main\\resources\\application.yml"))) {
